...
const MobileMenu = ({ toggleMenu }: MobileMenuProps): JSX.Element => {
  return (
    <>
      <div className="absolute top-0 left-0 z-30 h-screen w-screen bg-black opacity-30" />
      <aside className="flex flex-col absolute top-0 right-0 z-30 h-screen w-80 bg-white rounded-l-md p-6">
        <button
          type="button"
        ...
        <div className="pt-4 mt-6 border-t-2 mr-6 border-gray-100" />

        <ul className="flex flex-col mr-6">
          <li className="cursor-pointer text-indigo-400 py-2 px-4 bg-gray-100 rounded-md hover:underline">
            Início
          </li>
          <li className="py-2 px-4 cursor-pointer hover:underline">Baixar</li>
          <li className="py-2 px-4 cursor-pointer hover:underline">
            Por que usar o Discord?
          </li>
          <li className="py-2 px-4 cursor-pointer hover:underline">Nitro</li>
          <li className="flex py-2 cursor-pointer px-4 hover:underline">
            <p>Segurança</p>
            <svg
              className="caret-28iQeh"
              width="24"
              height="24"
              viewBox="0 0 24 24"
            >
          ...
          <li className="flex py-2 cursor-pointer px-4 hover:underline">
            <p>Academia de Moderadores</p>
            <svg
              className="caret-28iQeh ml-2"
              width="24"
              height="24"
              viewBox="0 0 24 24"
            >
          ...
          <li className="py-2 px-4 cursor-pointer hover:underline">Suporte</li>
        </ul>

        <button
          type="button"
          className="flex items-center justify-center py-2 px-4 w-full mt-auto bg-indigo-400 text-md text-white rounded-full transition-all hover:bg-indigo-300 hover:shadow-xl"
        >
          <svg
            width="24"
            height="24"
