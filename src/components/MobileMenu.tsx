  ...
  return (
    <>
      ...
      <aside className="flex flex-col absolute top-0 right-0 z-30 h-screen w-80 bg-white rounded-l-md p-6">
        ...
        <button className="flex items-center justify-center py-2 px-4 w-full mt-auto bg-indigo-400 text-md text-white rounded-full transition-all hover:bg-indigo-300 hover:shadow-xl">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
